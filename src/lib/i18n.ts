...
export const translations = {
  en: {
    ...
    // Wizard / form extras
    form_chooseService: "Choose a Service",
    form_pickDateTime: "Pick a Date & Time",
    form_loadingSlots: "Loading available slots...",
    form_reviewBooking: "Review Your Booking",
    form_service: "Service",
    form_dateTime: "Date & Time",
    form_personalDetails: "Personal Details",
    form_guest: "guest",
    form_guestsLabel: "guests",
    form_edit: "Edit",
    form_back: "Back",
    form_next: "Next",
    form_submitBooking: "Submit Booking",
  ...
  ar: {
    ...
    // Wizard / form extras
    form_chooseService: "اختر خدمة",
    form_pickDateTime: "اختر التاريخ والوقت",
    form_loadingSlots: "جارٍ تحميل المواعيد المتاحة...",
    form_reviewBooking: "مراجعة حجزك",
    form_service: "الخدمة",
    form_dateTime: "التاريخ والوقت",
    form_personalDetails: "البيانات الشخصية",
    form_guest: "ضيف",
    form_guestsLabel: "ضيوف",
    form_edit: "تعديل",
    form_back: "رجوع",
    form_next: "التالي",
    form_submitBooking: "إرسال الحجز",
