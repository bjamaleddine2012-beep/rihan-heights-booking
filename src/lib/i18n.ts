...
export const translations = {
  en: {
    ...
    // Recurring
    form_recurring: "Recurring Booking",
    form_oneTime: "One-time",
    form_weekly: "Weekly",
    form_biweekly: "Every 2 Weeks",
    form_monthly: "Monthly",
    form_recurrenceNote: "We'll create multiple bookings based on your recurrence.",
    ...
    detail_leftHome: "Left Home",
    detail_onTheWay: "On The Way",
    detail_arrived: "Arrived",
    detail_shareLocation: "Share My Live Location",
    detail_updateLocation: "Update My Location",
    detail_gettingLocation: "Getting location...",
    detail_locationShared: "Location shared",
    detail_viewMaps: "View on Maps",
  ...
  ar: {
    ...
    // Recurring
    form_recurring: "حجز متكرر",
    form_oneTime: "مرة واحدة",
    form_weekly: "أسبوعياً",
    form_biweekly: "كل أسبوعين",
    form_monthly: "شهرياً",
    form_recurrenceNote: "سنقوم بإنشاء عدة حجوزات بناءً على التكرار.",
    ...
    detail_leftHome: "غادرت المنزل",
    detail_onTheWay: "في الطريق",
    detail_arrived: "وصلت",
    detail_shareLocation: "شارك موقعي المباشر",
    detail_updateLocation: "تحديث موقعي",
    detail_gettingLocation: "جارٍ تحديد الموقع...",
    detail_locationShared: "تم مشاركة الموقع",
    detail_viewMaps: "عرض على الخريطة",
